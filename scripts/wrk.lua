...
--  wrk -t10 -c500 -d60s -s ./scripts/wrk.lua http://localhost:8080/login
--  wrk -t10 -c1000 -d60s -s ./scripts/wrk.lua http://localhost:8080/login
--  wrk -t20 -c1000 -d60s -s ./scripts/wrk.lua http://localhost:8080/login
--  wrk -t20 -c2000 -d20s -s ./scripts/wrk.lua http://localhost:8080/login
--  wrk -t20 -c2000 -d60s -s ./scripts/wrk.lua http://localhost:8080/login
--  wrk -t20 -c5000 -d60s -s ./scripts/wrk.lua http://localhost:8080/login
--  wrk -t10 -c5000 -d20s -s ./scripts/wrk.lua http://localhost:8080/login
